...
public class Time {
    ...
    public boolean isEarlier(Time time){
        if ((this.hours < time.getHours()) || ((this.hours == time.getHours()) && (this.minutes < time.getMinutes())) ||
           (((this.hours == time.getHours()) && (this.minutes == time.getMinutes()))&& (this.seconds < time.getSeconds()))){
            return true;}
        else{
            return false;}
    }
